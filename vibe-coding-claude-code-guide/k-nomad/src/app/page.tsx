...
const cities: City[] = [
  {
    ...
    tags: ["대도시", "교통", "커뮤니티"],
    visual: "from-slate-700 via-cyan-700 to-amber-300",
    mood: "초연결 대도시",
  },
  {
    name: "부산",
    ...
    tags: ["바다", "장기체류", "문화"],
    visual: "from-sky-600 via-teal-500 to-orange-300",
    mood: "해변 워케이션",
  },
  {
    name: "제주",
    ...
    tags: ["자연", "한달살기", "휴식"],
    visual: "from-emerald-700 via-lime-500 to-sky-300",
    mood: "자연 집중 환경",
  },
  {
    name: "강릉",
    ...
    tags: ["바다", "조용함", "카페"],
    visual: "from-blue-700 via-cyan-500 to-stone-200",
    mood: "동해안 집중",
  },
  {
    name: "대전",
    ...
    tags: ["중심지", "가성비", "교통"],
    visual: "from-zinc-700 via-indigo-500 to-emerald-300",
    mood: "균형형 거점",
  },
  {
    name: "전주",
    ...
    tags: ["문화", "가성비", "음식"],
    visual: "from-red-700 via-amber-500 to-lime-300",
    mood: "문화와 생활비",
  },
  {
    name: "광주",
    ...
    tags: ["문화", "가성비", "커뮤니티"],
    visual: "from-purple-700 via-rose-500 to-yellow-300",
    mood: "문화 기반 도시",
  },
  {
    name: "인천",
    ...
    tags: ["공항", "수도권", "바다"],
    visual: "from-cyan-800 via-blue-500 to-amber-200",
    mood: "이동성 중심",
  },
  {
    name: "춘천",
    ...
    tags: ["호수", "조용함", "가성비"],
    visual: "from-green-800 via-teal-500 to-sky-200",
    mood: "호수와 집중",
  },
];
    ...
    <section className="border-b">
      <div className="mx-auto grid w-full max-w-7xl gap-8 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_22rem] lg:px-8 lg:py-16">
        <div className="max-w-3xl">
          ...
          <div className="mt-7">
            <p className="mb-3 text-sm font-medium text-muted-foreground">인기 필터</p>
            <div className="flex flex-wrap gap-2">
              {popularFilters.map((filter) => (
                <Button key={filter} variant="outline" size="sm" className="bg-card">
                  {filter}
                </Button>
              ))}
            </div>
        ...
        <div className="grid gap-3 self-end rounded-lg border bg-card p-4 shadow-sm">
...
function CityExplorer() {
  return (
    ...
    >
      <div className="mb-5 grid gap-3 rounded-lg border bg-card p-3 sm:grid-cols-2 lg:grid-cols-4">
...
function ShareExperience() {
  return (
    <section className="px-4 pb-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl rounded-lg bg-primary px-5 py-10 text-primary-foreground sm:px-8 lg:flex lg:items-center lg:justify-between lg:gap-8">
        <div>
  ...
  return (
    <Card className="overflow-hidden">
      <div className={cn("relative h-36 bg-gradient-to-br", city.visual)}>
        <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,.18)_25%,transparent_25%,transparent_50%,rgba(255,255,255,.18)_50%,rgba(255,255,255,.18)_75%,transparent_75%,transparent)] bg-[length:24px_24px] opacity-30" />
        {rank ? (
          <div className="absolute left-3 top-3 flex h-8 w-8 items-center justify-center rounded-md bg-background/95 text-sm font-semibold text-foreground shadow-sm">
            {rank}
          </div>
        ) : null}
  ...
  return (
    <span
      className={cn(
        ...
        inverse ? "bg-black/30 text-white" : "bg-secondary text-secondary-foreground",
      )}
    >
